...
from (select pid, encounter, provider_id, facility_id, f1.date from form_encounter f1 where f1.date>(current_date() - INTERVAL 1 Month)) as fe
...
left join users atlas
   on atlas.id=b.user
where
b.user!= '1' and p.pid!='1' AND b.code != 'Claim' and
(
